                ...
                __PRIVATE__: A, open: function (f) {
                    ...
                    return a.forEach(H, function (b, c) {
                        ...
                        if (E.closeThisDialog = function (a) {
                            ...
                            var o = x(j.controller, a.extend(f, {$scope: E, $element: F}), !0, l);
                            j.bindToController && a.extend(o.instance, {
                                ngDialogId: E.ngDialogId,
                                ngDialogData: E.ngDialogData,
                                closeThisDialog: E.closeThisDialog
